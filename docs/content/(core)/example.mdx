...
5. Over the next 1–5 days for a standard draw (prefund/extended draws could select 7/14/30/60/90-day tenors), the Attestator sources USD by converting NGN through local liquidity providers.
