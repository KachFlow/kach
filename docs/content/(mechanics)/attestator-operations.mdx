...
Attestators have two methods to draw credit:
...
See [Prefund PRT System](/mechanics/prefund-prt) for complete details.
...
- Stake below minimum (requires top-up)
...
- [Prefund PRT System](/mechanics/prefund-prt): Advanced credit without upfront attestation
- [KachFlow Credit Engine](/core/kachflow): Core credit mechanics
- [Compliance](/governance/compliance): Regulatory requirements
